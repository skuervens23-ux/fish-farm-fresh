...
BEGIN
  ...
  INSERT INTO public.pembelian (petani_id, jenis_ikan, jumlah_kg, harga_per_kg, total_harga, status_bayar, jumlah_dibayar, dicatat_oleh)
  VALUES (_petani_id, _jenis_ikan, _jumlah_kg, _harga_per_kg, _total, _status_bayar, _bayar, auth.uid())
  RETURNING * INTO _row;
